...
RTS.Units.register({
  ...
  special: {
    // 举盾防御：减少远程伤害
    shieldBlock: {
      rangedDamageReduction: 0.4, // 减少40%远程伤害
      description: '举盾防御，减少40%远程伤害'
    },
    // 盾击：攻击有几率眩晕敌人
    shieldBash: {
      chance: 0.25, // 25%几率触发
      duration: 0.8, // 眩晕持续时间（秒）
      description: '攻击有25%几率眩晕敌人0.8秒'
    },
    // 格挡：有几率完全格挡近战攻击
    parry: {
      chance: 0.15, // 15%几率格挡
      description: '有15%几率完全格挡近战攻击'
    }
  },
  ...
  ai: {
    role: 'tank',
    weight: 1,
    desc: '高生命肉盾，克长矛与弓箭，可举盾防御',
  },

  doc: '刀盾兵（sword）：高生命肉盾单位。生命150、攻击13、近战射程1.0、攻速1.0s、移速2.0格/s、成本70、训练约1.3s。特色能力：1）举盾防御——减少40%远程伤害；2）盾击——攻击有25%几率眩晕敌人0.8秒；3）格挡——有15%几率完全格挡近战攻击。克制长矛兵（×1.2）与弓箭手（×1.3），但被骑兵冲击克制（对骑兵×0.8）。适合前排吸收伤害。',
