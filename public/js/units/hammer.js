...
RTS.Units.register({
  ...
  special: {
    // 破甲：无视部分护甲
    armorPierce: {
      armorReduction: 0.6, // 无视60%护甲
      description: '重锤破甲，无视60%护甲'
    },
    // 眩晕：攻击有几率眩晕敌人
    stun: {
      chance: 0.3, // 30%几率眩晕
      duration: 1.0, // 眩晕持续时间（秒）
      description: '攻击有30%几率眩晕敌人1秒'
    },
    // 重击：对建筑造成额外伤害
    structuralDamage: {
      buildingDamageBonus: 0.5, // 对建筑额外50%伤害
      towerDamageBonus: 0.3, // 对哨塔额外30%伤害
      description: '对建筑造成额外50%伤害，对哨塔额外30%伤害'
    }
  },
  ...
  ai: {
    role: 'siege',
    weight: 1,
    desc: '重锤破甲：克刀盾/弩手/肉盾，攻城伤害高，可眩晕敌人',
  },

  doc: '锤子兵（hammer）：重锤破甲的慢速近战单位。生命140、攻击24、近战射程1.1、攻速1.7s（慢）、移速1.7格/s（慢）、成本100、训练1.8s。特色能力：1）破甲——无视60%护甲；2）眩晕——攻击有30%几率眩晕敌人1秒；3）重击——对建筑造成额外50%伤害，对哨塔额外30%伤害。重锤可砸穿护甲与盾牌：对刀盾兵×1.4、对弩手×1.2、对肉盾×1.4，且对敌方基地额外造成×1.5伤害（攻城利器）；但速度慢，对弓箭手×0.85、对长矛兵×0.85，追不上远程部队，且挥击慢、怕被刀盾海包围。适合混在肉盾后输出重装目标与攻城拔寨，克制敌方肉盾/弩手集群。',
