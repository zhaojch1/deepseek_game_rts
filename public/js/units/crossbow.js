...
RTS.Units.register({
  ...
  doc: '弩手（crossbow）：远程重弩单位。生命75、攻击24、远程射程7.0格（比弓箭手更远）、攻速2.2s（比弓箭手更慢）、移速2.0格/s、成本110、训练4s。弩箭破甲：对骑兵伤害×1.3、对刀盾兵×1.1。单发伤害高、射程远，但装填慢，怕近战贴身与骑兵快速切入。适合后排集火点杀高价值目标与反重装。',
